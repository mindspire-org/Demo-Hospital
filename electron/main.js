...
// Force Electron to always use light theme, regardless of system dark mode.
// The app manages its own dark mode via CSS class toggling (.dark on scope elements).
