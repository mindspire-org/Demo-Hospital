...
export const sharedApi = {
  ...
  createDoctor: (data: { name: string; departmentIds?: string[]; primaryDepartmentId?: string; opdPublicFee?: number; opdPrivateFee?: number; opdSubsidizedFee?: number; opdFollowupFee?: number; followupWindowDays?: number; username?: string; password?: string; phone?: string; specialization?: string; clinicalModule?: string; qualification?: string; cnic?: string; pmdcNo?: string; shares?: number; opdShare?: number; ipdShare?: number; active?: boolean }) =>
    api('/hospital/doctors', { method: 'POST', body: JSON.stringify(data) }),
  updateDoctor: (id: string, data: { name?: string; departmentIds?: string[]; primaryDepartmentId?: string; opdPublicFee?: number; opdPrivateFee?: number; opdSubsidizedFee?: number; opdFollowupFee?: number; followupWindowDays?: number; username?: string; password?: string; phone?: string; specialization?: string; clinicalModule?: string; qualification?: string; cnic?: string; pmdcNo?: string; shares?: number; opdShare?: number; ipdShare?: number; active?: boolean; prescriptionTemplate?: string; prescriptionLanguage?: string; prescriptionDesign?: any }) =>
