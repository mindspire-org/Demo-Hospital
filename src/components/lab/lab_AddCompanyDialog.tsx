...
export default function Lab_AddCompanyDialog({ open, onClose, onSave, initial = null, title = 'Add Company', submitLabel = 'Save', distributorPrefill: _distributorPrefill = null }: Props) {
  if (!open) return null
