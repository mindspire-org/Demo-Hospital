    ...
    <>
      <style>{`
        ...
        @media print {
          ...
          #pharmacy-receipt { position: absolute !important; left: 0; right: 0; top: 0; margin: 0 auto !important; padding: 0 6px !important; width: 384px !important; box-sizing: content-box !important; line-height: 1.25; overflow: visible !important; z-index: 2147483647; background: #fff !important }
          .no-print { display: none !important }
          .only-print { display: block !important }
          #pharmacy-receipt hr { border-color: #000 !important }
          #pharmacy-receipt, #pharmacy-receipt * { color: #000 !important; background: transparent !important; background-color: transparent !important; border-color: #000 !important }
