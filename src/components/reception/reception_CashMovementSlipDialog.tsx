...
export default function Reception_CashMovementSlipDialog({ open, onClose, entry }: Props) {
  const [info] = useState<{ name: string; phone: string; address: string; footer: string; logo: string }>({ name: 'RECEPTION', phone: '', address: '', footer: 'Have a nice day!', logo: '' })
    ...
    <>
      <style>{`
        ...
        @media print {
          ...
          #cash-slip { position: absolute !important; left: 0; right: 0; top: 0; margin: 0 auto !important; padding: 0 6px !important; width: 384px !important; box-sizing: content-box !important; line-height: 1.25; overflow: visible !important; z-index: 2147483647; background: #fff !important }
          .no-print { display: none !important }
          .only-print { display: block !important }
          #cash-slip hr { border-color: #000 !important }
          #cash-slip, #cash-slip * { color: #000 !important; background: transparent !important; background-color: transparent !important; border-color: #000 !important }
        }
      `}</style>
