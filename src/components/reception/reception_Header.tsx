...
export default function Reception_Header({ onToggleSidebar, onToggleTheme, theme, variant = 'default' }: Props) {
  ...
  const displayName = user?.username || 'reception'
      ...
      <div className={innerCls}>
        ...
        <Link to="/reception" className="flex items-center gap-2">
          ...
          <div className="flex flex-col leading-tight">
            <div className={titleCls}>Reception Portal</div>
            <div className="text-[10px] uppercase tracking-wider text-white/60">Front Desk & Patient Services</div>
          </div>
