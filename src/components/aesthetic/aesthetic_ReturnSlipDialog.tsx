    ...
    <div className="fixed inset-0 z-50 flex items-start justify-center bg-black/40 px-4 py-6 print:static print:p-0 print:bg-white">
      <style>{`
        ...
        @media print {
          ...
          #pharmacy-return-slip { position: absolute !important; left: 0; right: 0; top: 0; margin: 0 auto !important; padding: 0 6px !important; width: 384px !important; box-sizing: content-box !important; line-height: 1.25; z-index: 2147483647; background: #fff !important }
          .no-print { display: none !important }
          #pharmacy-return-slip hr { border-color: #000 !important }
          #pharmacy-return-slip, #pharmacy-return-slip * { color: #000 !important; background: transparent !important; background-color: transparent !important; border-color: #000 !important }
