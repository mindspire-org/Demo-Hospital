...
export default function IndoorPharmacy_POSCart({ cart, products, productIndex, onInc, onDec, onRemove, onClear, onSetQty, onSetSellBy, onQtyEnter, onSetLineDiscountPct }: Props) {
  return (
          ...
          return (
            <div key={line.id} className="flex items-center gap-3 p-4">
              ...
              <div className="flex items-center gap-2">
                ...
                <input
                  id={`indoorpharmacy-pos-qty-${line.id}`}
                  type="number"
                  min={1}
                  value={line.qty}
                  onChange={e=>{
