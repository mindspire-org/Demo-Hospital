export default function NewBornBabyForm({ data, onChange }: { data: any; onChange: (data: any) => void }) {
  const exam = data || {}
      ...
      <div className="border border-slate-300 p-3 space-y-3">
        ...
        <div className="border border-slate-300 p-2 bg-white">
          ...
          <div className="grid grid-cols-3 gap-2 mb-2">
            <div>
              <label className="block mb-1 text-xs font-semibold">DIAGNOSIS:</label>
        ...
        <div className="border border-slate-300 p-2 bg-white">
          ...
          <div className="overflow-x-auto">
            <table className="w-full border border-slate-300 text-xs">
              ...
              <tbody>
                ...
                <tr>
                  <td className="border border-slate-300 px-2 py-1 font-semibold">Pulse (Heart rate)</td>
          ...
          <div className="mt-3 border border-slate-300 p-2 bg-slate-50">
            <div className="grid grid-cols-2 gap-2">
              <div>
                <label className="block mb-1 text-xs font-semibold">APGAR SCORE AT 1 MINUTE=</label>
              ...
              <div>
                <label className="block mb-1 text-xs font-semibold">APGAR SCORE AT 5 MINUTE=</label>
