        ...
        <div className="flex-1 overflow-y-auto px-6 py-5">
          <div className="grid gap-4 sm:grid-cols-2">
            ...
            <div>
              ...
              <input name="position" defaultValue={initial?.position} placeholder="e.g. Reception" className="w-full rounded-md border border-slate-300 px-3 py-2 text-sm" required />
            </div>
            <div>
