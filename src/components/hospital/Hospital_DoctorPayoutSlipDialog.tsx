    ...
    <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/40 p-4 print:bg-white print:static">
      ...
      <style>{`
        @media print {
          ...
          #hospital-doctor-payout-slip { position: absolute !important; left: 0; right: 0; top: 0; margin: 0 auto !important; width: auto !important; max-width: 190mm !important; box-sizing: border-box !important; overflow: visible !important; z-index: 2147483647; color: #000 !important; background: #fff !important }
          #hospital-doctor-payout-slip, #hospital-doctor-payout-slip * { color: #000 !important; background: transparent !important; background-color: transparent !important; border-color: #000 !important }
