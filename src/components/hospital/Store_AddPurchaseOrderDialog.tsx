...
const Store_AddPurchaseOrderDialog: React.FC<Props> = ({ open, onClose, onSave, initial }) => {
  ...
  useEffect(() => {
    if (open) {
      ...
      if (initial) {
        ...
        setSupplierCompany(initial.supplierCompany || '');
        setSupplierAddress(initial.supplierAddress || '');
        setSupplierTaxId(initial.supplierTaxId || '');
    ...
    <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/50 p-4">
      <div className="flex h-full max-h-[90vh] w-full max-w-4xl flex-col rounded-xl bg-white shadow-xl">
        ...
        <div className="flex-1 overflow-y-auto p-6">
          ...
          {/* Items Section - Grid Layout (No Scrolling) */}
          <div className="mt-8">
...
export default Store_AddPurchaseOrderDialog;
