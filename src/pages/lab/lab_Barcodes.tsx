                  ...
                  <tr key={o.id} className="border-b border-slate-100">
                    ...
                    <td className="px-3 py-2">
                      <div className="flex items-center gap-1">
                        <button onClick={() => openAssign(o)} className="rounded-md border border-slate-300 px-2 py-1 text-xs hover:bg-slate-50">Barcode</button>
                        <button onClick={() => { setTrackTokenNo(token); setTrackOpen(true) }} className="rounded-md border border-slate-300 px-2 py-1 text-xs hover:bg-slate-50"><Clock className="h-3 w-3" /></button>
                      </div>
                    </td>
                  </tr>
                )
