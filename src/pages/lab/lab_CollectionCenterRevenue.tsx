    ...
    <div className="p-4 md:p-6 w-full min-h-[calc(100dvh-3.5rem)] bg-slate-50 dark:bg-slate-900/50">
      ...
      <div className="flex flex-col md:flex-row md:items-center md:justify-between gap-4 mb-6 bg-white dark:bg-slate-800 p-6 rounded-xl shadow-sm border border-slate-200 dark:border-slate-700">
        <div>
          ...
          <p className="text-slate-500 dark:text-slate-400 mt-1">Analyze revenue and commissions generated by collection centers</p>
        </div>
        <div className="flex items-center gap-3">
          <button 
            onClick={printReport}
            disabled={revenueData.length === 0}
            className="inline-flex items-center gap-2 px-4 py-2 bg-white dark:bg-slate-700 border border-slate-200 dark:border-slate-600 rounded-lg text-slate-700 dark:text-slate-200 font-semibold hover:bg-slate-50 dark:hover:bg-slate-600 transition-all shadow-sm disabled:opacity-50 disabled:cursor-not-allowed"
          >
