...
import Lab_AssignSupplierCompaniesDialog from '../../components/lab/lab_AssignSupplierCompaniesDialog'
...
export default function Lab_Suppliers() {
  ...
  return (
    <div className="space-y-4">
            ...
            <div key={s.id} className="rounded-xl border border-slate-200 bg-white p-4">
              <div className="flex items-start justify-between">
                ...
                <div className="flex items-center gap-2">
                  ...
                  <button onClick={()=>openAssignCompanies(s)} className="rounded-md border border-slate-300 px-2 py-1 text-xs hover:bg-slate-50">Assign Companies</button>
      ...
      <Lab_AssignSupplierCompaniesDialog open={assignCompaniesOpen} onClose={()=>setAssignCompaniesOpen(false)} supplier={selected} />
