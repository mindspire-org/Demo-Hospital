...
import IndoorPharmacy_ReturnDialog from '../../components/indoorpharmacy/indoorpharmacy_ReturnDialog'
import IndoorPharmacy_ReturnSlipDialog from '../../components/indoorpharmacy/indoorpharmacy_ReturnSlipDialog'
...
export default function IndoorPharmacy_Returns() {
  ...
  useEffect(() => {
    ...
    ;(async () => {
      setLoading(true)
      try {
        const res: any = await indoorPharmacyApi.listSales({ bill: invoiceId || undefined, customer: customer || undefined, phone: phone || undefined, from: from || undefined, to: to || undefined, page, limit })
        if (!mounted) return
  ...
  return (
    <div className="space-y-4">
      ...
      <IndoorPharmacy_ReturnSlipDialog
        open={slip.open}
