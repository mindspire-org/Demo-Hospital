...
export default function IndoorPharmacy_Settings() {
  ...
  const savePharmacy = async () => {
    await indoorPharmacyApi.updateSettings({ pharmacyName, phone, address, email, billingFooter, logoDataUrl: logoDataUrl || '' })
