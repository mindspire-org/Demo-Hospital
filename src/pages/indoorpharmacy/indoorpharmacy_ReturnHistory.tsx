...
export default function IndoorPharmacy_ReturnHistory() {
  ...
  useEffect(() => {
    ...
    ;(async () => {
      setLoading(true)
      try {
        const res: any = await indoorPharmacyApi.listReturns({ type: type === 'All' ? undefined : (type === 'Customer' ? 'Patient' : type), from: from || undefined, to: to || undefined, search: search || undefined, phone: phone || undefined, page, limit })
