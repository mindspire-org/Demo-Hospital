...
import IndoorPharmacy_SupplierReturnDialog from '../../components/indoorpharmacy/indoorpharmacy_SupplierReturnDialog'
...
export default function IndoorPharmacy_SupplierReturns() {
  ...
  useEffect(() => {
    ...
    ;(async () => {
      try {
        const res: any = await indoorPharmacyApi.listPurchases({ from: from || undefined, to: to || undefined, search: (invoice || supplier) || undefined, page, limit })
  ...
  return (
    <div className="space-y-4">
      ...
      <IndoorPharmacy_SupplierReturnDialog
        open={!!selected}
