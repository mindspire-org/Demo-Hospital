            ...
            <table className="min-w-full text-sm">
              <thead className="bg-slate-100/50 text-slate-700 border-b-2 border-slate-300">
                <tr className="text-left">
                  <th className="px-2 py-3 text-[13px] font-extrabold uppercase tracking-wider">Name</th>
                  <th className="px-2 py-3 text-[13px] font-extrabold uppercase tracking-wider">Code</th>
                  <th className="px-2 py-3 text-[13px] font-extrabold uppercase tracking-wider">Contact</th>
                  <th className="px-2 py-3 text-[13px] font-extrabold uppercase tracking-wider">Phone</th>
                  <th className="px-2 py-3 text-[13px] font-extrabold uppercase tracking-wider">Email</th>
                  <th className="px-2 py-3 text-[13px] font-extrabold uppercase tracking-wider">Billing</th>
