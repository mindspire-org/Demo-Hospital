...
export default function Hospital_ERBilling() {
  ...
  useEffect(() => {
    if (!urlTokenId) {
      ...
      hospitalApi.listTokens({ status: 'in-progress', limit: 50 })
        .then((res: any) => {
          setAvailableTokens(res?.tokens || [])
        })
              ...
              <table className="min-w-full text-left text-sm">
                <thead className="bg-slate-50 text-slate-700">
                  <tr>
                    ...
                    <th className="px-3 py-2 font-medium">Admit Date/Time</th>
                    <th className="px-3 py-2 font-medium">Bed No</th>
                        ...
                        <div className="flex items-center gap-2 flex-wrap">
                          {!c.rowRemaining || c.rowRemaining <= 0 ? (
                            ...
                            <>
                              ...
                              <button
                                onClick={()=>setOpenCollectPayment({ id: c.id, description: c.description, remaining: c.rowRemaining })}
