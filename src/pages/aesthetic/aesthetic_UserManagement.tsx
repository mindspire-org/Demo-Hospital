...
export default function Aesthetic_UserManagement() {
  ...
  const openEdit = (u: User) => setEditing({ _id: u._id, username: u.username, role: u.role as User['role'], password: '' })
  const saveEdit = async () => {
    ...
    try {
      ...
      const updated = await aestheticApi.updateUser(editing._id, payload) as any
