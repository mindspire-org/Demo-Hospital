export const MODULE_REGISTRY = {
  hospital: {
    ...
    subModules: {
      ...
      dentalRx:    { label: 'Dental Prescription (Tooth Chart)', pathPrefixes: ['/hospital/rx-feature/dental'] },
      eyeRx:       { label: 'Eye Prescription (Examination)',    pathPrefixes: ['/hospital/rx-feature/eye'] },
      cardiacRx:   { label: 'Cardiac Prescription (ECG/Echo)',   pathPrefixes: ['/hospital/rx-feature/cardiac'] },
      breastOncoRx:{ label: 'Breast Oncology Prescription',      pathPrefixes: ['/hospital/rx-feature/breast'] },
      omfsRx:      { label: 'Oral & Maxillofacial Prescription', pathPrefixes: ['/hospital/rx-feature/omfs'] },
      neuroRx:     { label: 'Neurology Prescription',            pathPrefixes: ['/hospital/rx-feature/neuro'] },
      deptQueue:   { label: 'Department Patient List & Progress',pathPrefixes: ['/hospital/department-queue'] },
  ...
  cafeteria: {
    label: 'Cafeteria',
    subModules: {
      pos:        { label: 'POS',        pathPrefixes: ['/cafeteria/pos'] },
      menuItems:  { label: 'Menu Items', pathPrefixes: ['/cafeteria/menu-items'] },
      sales:      { label: 'Sales',      pathPrefixes: ['/cafeteria/sales-history'] },
      reports:    { label: 'Reports',    pathPrefixes: ['/cafeteria/reports'] },
      settings:   { label: 'Settings',   pathPrefixes: ['/cafeteria/settings','/cafeteria/user-management','/cafeteria/audit-logs','/cafeteria/sidebar-permissions'] },
    },
  },
} as const
