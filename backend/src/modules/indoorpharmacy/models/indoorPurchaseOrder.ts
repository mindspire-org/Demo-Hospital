...
}, { timestamps: true, collection: 'indoorpharmacy_purchase_orders' })
...
export const PurchaseOrder = models.IndoorPharmacy_PurchaseOrder || model('IndoorPharmacy_PurchaseOrder', PurchaseOrderSchema)
