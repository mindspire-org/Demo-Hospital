...
}, { timestamps: true, collection: 'indoorpharmacy_hold_purchase_invoices' })
...
export const HoldPurchaseInvoice = models.IndoorPharmacy_HoldPurchaseInvoice || model('IndoorPharmacy_HoldPurchaseInvoice', HoldPurchaseInvoiceSchema)
