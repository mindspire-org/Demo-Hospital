...
}, { timestamps: true, collection: 'indoorpharmacy_inventoryitems' })
...
export const InventoryItem = models.IndoorPharmacy_InventoryItem || model('IndoorPharmacy_InventoryItem', InventoryItemSchema)
