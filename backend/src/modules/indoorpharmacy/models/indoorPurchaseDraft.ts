...
}, { timestamps: true, collection: 'indoorpharmacy_purchasedrafts' })
...
export const PurchaseDraft = models.IndoorPharmacy_PurchaseDraft || model('IndoorPharmacy_PurchaseDraft', PurchaseDraftSchema)
