...
export interface IIpdPharmacyOrderItem {
  name: string
  qty: number
  dose?: string
  notes?: string
...
export interface IIpdPharmacyOrder extends Document {
  encounterId: mongoose.Types.ObjectId
  patientId: mongoose.Types.ObjectId
  doctorId?: mongoose.Types.ObjectId
  items: IIpdPharmacyOrderItem[]
...
const IpdPharmacyOrderSchema = new Schema({
...
export const IpdPharmacyOrder = mongoose.model<IIpdPharmacyOrder>('Hospital_IpdPharmacyOrder', IpdPharmacyOrderSchema)
