...
export const diagnosticTokenCreateSchema = z.object({
  ...
  portal: z.enum(['diagnostic', 'reception']).optional(),
  // Corporate billing
...
export const diagnosticTokenQuerySchema = z.object({
  q: z.string().optional(),
  status: z.enum(['token_generated', 'converted_to_sample', 'cancelled']).optional(),
