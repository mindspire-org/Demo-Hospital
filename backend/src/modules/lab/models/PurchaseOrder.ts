...
}, { timestamps: true, collection: 'lab_purchase_orders' })

export type LabPurchaseOrderDoc = {
  _id: string
  poNumber: string
  orderDate: string
...
export const LabPurchaseOrder = models.Lab_PurchaseOrder || model('Lab_PurchaseOrder', PurchaseOrderSchema)
