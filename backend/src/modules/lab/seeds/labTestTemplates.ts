...
export const SEED_TEMPLATES: TemplateSeed[] = [
  // CBC with 100% differential rule
  {
    ...
    parameters: [
      { name: 'Hb', unit: 'g/dL', normalRange: '12 - 16', decimals: 1, sectionKey: 'main', criticalMin: 7, criticalMax: 20 },
      { name: 'TLC', unit: '10^9/L', normalRange: '4 - 11', decimals: 1, sectionKey: 'main', criticalMin: 1, criticalMax: 30 },
      { name: 'RBC', unit: '10^12/L', normalRange: '4.5 - 5.9', decimals: 2, sectionKey: 'main' },
      { name: 'Platelets', unit: '10^9/L', normalRange: '150 - 450', decimals: 0, sectionKey: 'main', criticalMin: 50, criticalMax: 1000 },
      { name: 'Hct', unit: '%', normalRange: '36 - 50', decimals: 1, sectionKey: 'main' },
      { name: 'MCV', unit: 'fL', normalRange: '80 - 100', decimals: 1, sectionKey: 'main' },
      { name: 'MCH', unit: 'pg', normalRange: '27 - 33', decimals: 1, sectionKey: 'main' },
      { name: 'MCHC', unit: 'g/dL', normalRange: '32 - 36', decimals: 1, sectionKey: 'main' },
      { name: 'Neutrophils', unit: '%', normalRange: '40 - 75', decimals: 0, sectionKey: 'diff', contributesToTotalPercent: true, totalPercentGroup: 'cbc-diff' },
      { name: 'Lymphocytes', unit: '%', normalRange: '20 - 45', decimals: 0, sectionKey: 'diff', contributesToTotalPercent: true, totalPercentGroup: 'cbc-diff' },
      { name: 'Monocytes',   unit: '%', normalRange: '2 - 10',  decimals: 0, sectionKey: 'diff', contributesToTotalPercent: true, totalPercentGroup: 'cbc-diff' },
      { name: 'Eosinophils', unit: '%', normalRange: '1 - 6',   decimals: 0, sectionKey: 'diff', contributesToTotalPercent: true, totalPercentGroup: 'cbc-diff' },
      { name: 'Basophils',   unit: '%', normalRange: '0 - 1',   decimals: 0, sectionKey: 'diff', contributesToTotalPercent: true, totalPercentGroup: 'cbc-diff' },
    ],
  },
  ...
  // HbA1c with auto-interpretation
  {
    ...
    price: 1200,
    parameters: [
      { name: 'HbA1c', unit: '%', normalRange: '4.0 - 5.6', decimals: 1, criticalMin: 0, criticalMax: 15 },
    ],
    interpretationRules: [
  ...
  // TFT
  {
    ...
    price: 2500,
    parameters: [
      { name: 'TSH', unit: 'µIU/mL', normalRange: '0.4 - 4.0', decimals: 2 },
      { name: 'T3',  unit: 'ng/mL',  normalRange: '0.8 - 2.0', decimals: 2 },
      { name: 'T4',  unit: 'µg/dL',  normalRange: '5 - 12',    decimals: 1 },
    ],
  },
  ...
  // Urine RE — 3 sections
  {
    ...
    parameters: [
      ...
      { name: 'Sp. Gravity', sectionKey: 'physical', normalRange: '1.005 - 1.030', decimals: 3 },
      { name: 'pH', sectionKey: 'physical', normalRange: '4.5 - 8.0', decimals: 1 },
      ...
      { name: 'Pus Cells (HPF)', sectionKey: 'microscopic', normalRange: '0 - 5' },
      { name: 'RBC (HPF)', sectionKey: 'microscopic', normalRange: '0 - 2' },
  ...
  { name: 'Anti-HCV', category: 'Serology', template: 'qualitative', price: 700, parameters: [{ name: 'Anti-HCV', kind: 'qualitative', qualitativeOptions: ['Non-Reactive', 'Reactive'] }] },
  { name: 'HBsAg',    category: 'Serology', template: 'qualitative', price: 600, parameters: [{ name: 'HBsAg',    kind: 'qualitative', qualitativeOptions: ['Non-Reactive', 'Reactive'] }] },
  ...
  // Lipid (formula-driven LDL)
  {
    ...
    price: 1500,
    parameters: [
      { name: 'Total Cholesterol', unit: 'mg/dL', normalRange: '< 200', decimals: 0 },
      { name: 'Triglycerides',     unit: 'mg/dL', normalRange: '< 150', decimals: 0 },
      { name: 'HDL',               unit: 'mg/dL', normalRange: '> 40',  decimals: 0 },
      { name: 'LDL',               unit: 'mg/dL', normalRange: '< 100', decimals: 0, formula: '{Total Cholesterol} - {HDL} - ({Triglycerides} / 5)', dependsOn: ['Total Cholesterol', 'HDL', 'Triglycerides'] },
    ],
  },
  ...
  // LFT
  {
    ...
    price: 1300,
    parameters: [
      { name: 'Total Bilirubin', unit: 'mg/dL', normalRange: '0.2 - 1.2', decimals: 2 },
      { name: 'Direct Bilirubin', unit: 'mg/dL', normalRange: '0 - 0.4', decimals: 2 },
      { name: 'ALT (SGPT)', unit: 'U/L', normalRange: '< 40', decimals: 0 },
      { name: 'AST (SGOT)', unit: 'U/L', normalRange: '< 40', decimals: 0 },
      { name: 'Alkaline Phosphatase', unit: 'U/L', normalRange: '40 - 130', decimals: 0 },
      { name: 'Total Protein', unit: 'g/dL', normalRange: '6.0 - 8.3', decimals: 1 },
      { name: 'Albumin', unit: 'g/dL', normalRange: '3.5 - 5.0', decimals: 1 },
    ],
  },
  ...
  // RFT
  {
    ...
    price: 1100,
    parameters: [
      { name: 'Urea', unit: 'mg/dL', normalRange: '15 - 45', decimals: 0, criticalMax: 200 },
      { name: 'Creatinine', unit: 'mg/dL', normalRange: '0.6 - 1.3', decimals: 2, criticalMax: 8 },
      { name: 'Sodium', unit: 'mmol/L', normalRange: '135 - 145', decimals: 0, criticalMin: 120, criticalMax: 160 },
      { name: 'Potassium', unit: 'mmol/L', normalRange: '3.5 - 5.0', decimals: 2, criticalMin: 2.5, criticalMax: 6.5 },
      { name: 'Chloride', unit: 'mmol/L', normalRange: '98 - 107', decimals: 0 },
    ],
  },
  ...
  // Semen
  {
    ...
    parameters: [
      { name: 'Volume', unit: 'mL', normalRange: '> 1.5', decimals: 1, sectionKey: 'physical' },
      { name: 'Colour', sectionKey: 'physical', kind: 'qualitative', qualitativeOptions: ['Greyish-white', 'Yellow', 'Brown'] },
      { name: 'Liquefaction time', unit: 'min', normalRange: '< 60', decimals: 0, sectionKey: 'physical' },
      { name: 'Viscosity', sectionKey: 'physical', kind: 'qualitative', qualitativeOptions: ['Normal', 'Increased'] },
      { name: 'pH', normalRange: '7.2 - 8.0', decimals: 1, sectionKey: 'physical' },
      { name: 'Sperm count', unit: 'million/mL', normalRange: '> 15', decimals: 0, sectionKey: 'microscopic' },
      { name: 'Motility (active)', unit: '%', normalRange: '> 32', decimals: 0, sectionKey: 'microscopic' },
      { name: 'Morphology (normal forms)', unit: '%', normalRange: '> 4', decimals: 0, sectionKey: 'microscopic' },
      { name: 'Pus cells', unit: '/HPF', normalRange: '< 5', decimals: 0, sectionKey: 'microscopic' },
      { name: 'RBCs', unit: '/HPF', normalRange: 'Nil', sectionKey: 'microscopic' },
